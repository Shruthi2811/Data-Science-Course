...
# (data_file, delimiter, header_present_flag, label_index, fraction)
#
# 1) data_file = The data file name (with the full path if the file is not in the same folder as the python file)
#
# 2) delimiter = The delimiter used to separate the columns in the data
#
# 3) header_present_flag = True/False. Used to notify whether the data file contains the first row as column header or not
#
# 4) label_index = Need to give the index of the label column.
#    NOTE: Index starts at 0 and not 1 !!!
#
# 5) fraction: The fraction in which the data needs to be divided as training and test.
#    Eg: If 0.1 is given, then it randomly assigns 10% of the data as train and rest 90% as test.
